	...
	<!-- Custom fonts for this template-->
 	<link href="resources/vendor/fontawesome-free/css/all.min.css" rel="stylesheet" type="text/css">
  	...
  	<script type="text/javascript">
		...
		{
		var xmlhttp;
		var k=document.getElementById("section").value;
		var urls="Checkduplicatesection?section="+k;
		  ...
		  if (xmlhttp.readyState==4)
		    {
				...
				if(result=="FAILURE")
					{
					 document.getElementById("result").innerHTML="Section already present";
					}
				else
					{
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800">ADD SECTION</h1>
          <div class="mb-4" id="result" style="color: red;">
          	<%
          ...
          <div class="row">
            <div class="col-xl-8 col-lg-7">
	              ...
	              <div class="card shadow mb-4">
	                ...
	                <div class="card-body">
		              <form id="addsectionform" action="Addsection" method="post" class="form-horizontal">
		              <fieldset>
		                <!-- Form Name -->
		                
		                <div class="form-group">
		                  <label class="col-md-4 control-label" for="section ">Section name</label>  
		                  <div class="col-md-10">
		                  <input id="section" name="section" type="text" placeholder="Add Section" class="form-control form-control-lg input-md" onchange="loadXMLDoc()" required>
		                  </div>
		                </div>
		                ...
		                <div class="form-group">
		                  ...
		                  <div class="col-md-4">
		                    <button class="btn-lg btn-primary" id="submit" type="submit" value="submit" disabled>submit</button>
