		  ...
		  <div class="row">
            ...
            <div class="col-xl-8 col-lg-7">
              ...
              <div class="card shadow mb-4">
                ...
                <div class="card-body">
              <form id="editExamForm" method="post" action="Editexam1?examId=<%=request.getAttribute("examId") %>" class="form-horizontal">
              <fieldset>
                <!-- Form Name -->
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-10">
                  <input id="exam" name="exam" type="text" placeholder="add exam" disabled="disabled" value="<%= request.getAttribute("Exam") %>" class="form-control form-control-lg input-md" required>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-6">                    
                  <input type="date" value="<%= request.getAttribute("startDate") %>" name="startDate" min="<%= request.getAttribute("currentDate") %>" class="form-control form-control-lg" id="datetime" style="width: 100%;"  name="appt"  required> 
                  </div>
                </div>
