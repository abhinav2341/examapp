		 ...
		 <h1 class="h3 mb-2 text-gray-800">Set Question paper</h1>
          ...
          <div class="row">
            ...
            <div class="col-xl-8 col-lg-7">
              ...
              <div class="card-body">
              	<form id="editQuestionForm" action="Editquestion1" method="post">
                              	
                <div class="form-group">
                <label>Question</label>  
                <textarea id="Question" name="Question_ip" rows="4" cols="50" value="<%=request.getAttribute("question")%>"><%=request.getAttribute("question")%></textarea>   
                </div>
                              
                <!-- Text input-->
                <div class="form-group">
                  <label>option 1</label>  
                  <textarea id="option 1"  name="option_ip1" rows="2" cols="50" value="<%=request.getAttribute("option1")%>"><%=request.getAttribute("option1")%></textarea>
                </div>
                
                <!-- Text input-->
                <div class="form-group">
                  <label>option 2</label>  
				<textarea id="option2" rows="2" name="option_ip2" cols="50" value="<%=request.getAttribute("option2")%>"><%=request.getAttribute("option2")%></textarea>
                </div>
                
                <!-- Text input-->
                <div class="form-group">
                  <label>option 3</label>  
                  <textarea id="option3" name="option_ip3" rows="2" cols="50"value="<%=request.getAttribute("option3")%>"><%=request.getAttribute("option3")%></textarea>
                </div>
                
                <div class="form-group">
                  <label>option 4</label>  
               	<textarea id="option4" name="option_ip4" rows="2" cols="50" value="<%=request.getAttribute("option4")%>" ><%=request.getAttribute("option4")%></textarea>
                </div>
                
                <div class="form-group">
                  <label >correct option</label><br>
                  <input type="number" max=4 min=1 name="correct" value="<%= request.getAttribute("correct")%>">
                </div>
