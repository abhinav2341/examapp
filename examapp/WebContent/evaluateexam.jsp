...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item">
        <a class="nav-link" href="Evaluateexam1">
          <i class="fas fa-fw fa-tachometer-alt"></i>
          <span>Evaluate exams</span></a>
      </li>         
    </ul>
    <!-- End of Sidebar -->
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800">Evaluate Exam</h1>
          ...
          <div class="row">
            <div class="col-xl-8 col-lg-7">
	              ...
	              <div class="card shadow mb-4">
	                ...
	                <div class="card-body">
		              <form id="evaluateexamform" action="Evaluateexam" method="post" class="form-horizontal">
		              <fieldset>
		                <!-- Form Name -->
		                
		                <div class="form-group">
		                  <label class="col-md-4 control-label" for="selectexam">Exam</label>
		                  <div class="col-md-10">
		                    <select id="selectexam" name="selectexam" class="form-control form-control-lg">
