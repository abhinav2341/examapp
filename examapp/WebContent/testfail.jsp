          ...
          <div class="row">
            ...
            <div class="col-xl-8 col-lg-7">
              ...
              <div class="card shadow mb-4">
                ...
                <div class="card-body">
              <h1>Test not scheduled today..</h1>
              
              <br>
              
              <div data-role="content">	
     			<!-- <button id="back" type="button" class="btn btn-lg btn-primary" onclick="viewexamSt();">View tests</button> -->
				<a href="viewexamSt?userId=<%=session.getAttribute("userId") %>" class="btn btn-lg btn-primary">View Test</a>  
	</div>
