      ...
      <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" method="post" href="Addquestion1">ADD</a>
            <a class="collapse-item" href="Viewquestions">View</a>
          </div>
        </div>
      </li>
       <li class="nav-item">
        <a class="nav-link" href="Viewresults">
          <i class="fas fa-fw fa-tachometer-alt"></i>
      ...
      <div id="content">
        ...
        <div class="row">
            ...
            <div class="col-xl-8 col-lg-7">
              ...
              <div class="card-body">
              	<form id="addQuestionForm" action="Scorecard" method="post">
               		<div class="form-group">
			                  <label>Select Section</label>  
			                  <div>
			                  <select id="select_exam" name="select_exam" class="form-control">
			                     <option value="0" selected="true">Select exam</option>
					               <%
									 Map<Integer, String> userMap1 = request.getAttribute("userMap") != null ? (Map<Integer, String>)request.getAttribute("userMap") : null;
									%> 
									<%  if(userMap1 != null) {
									  	 for(Map.Entry<Integer, String> entry : userMap1.entrySet()) {%>
			                ...
			                <div class="form-group">
			                  <div class="col-md-4">
			                    <button class="btn btn-primary" id="submit" type="submit" >View Result</button>
			                  </div>
		                	</div> 
			                </form>
			                </div>
