 ...
 */
@WebServlet(description = "Servlet to fetch exam details from DB and view scheduled exam", urlPatterns = { "/viewexam" })
public class viewexam extends HttpServlet {
	private static final long serialVersionUID = 1L;
    
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		// TODO Auto-generated method stub
		System.out.println("View exam servletworking...");
		...
		try {
			...
			ps = con.prepareStatement("select * from exam_schedule");
